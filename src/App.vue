...
<template>
    <div class="wrapper mt-0 sm:mt-32 sm:px-6">
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          <div className="lg:order-first lg:row-span-2 p-8">
            ...
            <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400 bg-gray-900 rounded-xl shadow-lg p-8 w-full">
              ...
              <div id="tera-type-picker">
                ...
                <div class="grid gap-4 sm:grid-cols-6 grid-cols-7 grid-rows-3">
          ...
          <div id="col-2" class="p-8 wrapper flex flex-col mb-80 gap-4">
            <div id="selected-pokemon" class="w-full pl-48 py-6 pb-8 relative flex flex-col bg-gray-900 rounded-lg shadow-lg" v-if="pokedex.selectedPokemon">
              ...
              <div class="w-48 -left-36 -top-12 absolute">
                <img 
            ...
            <div id="tactics" class="card px-8">
              ...
              <div id="player-defense" class="lex flex-row items-start mt-3">
                ...
                <div class="flex flex-row items-center">
                  <p class="text-sm font-medium mb-3 mr-4 text-gray-300 font-mono mt-2 w-36 flex-shrink-0">Defense type:</p>
                  <img class="w-6 mr-1" :src="`/icons/${pokedex.pokemonPrimaryAttackVector}.png`" /><span class="w-5 font-mono text-white text-sm">{{ pokedex.pokemonPrimaryAttackVector }}</span>
                </div>
              </div>
              <h2 class="text-2xl font-bold text-white mb-2 mt-8">Your offense</h2>
              <div id="player-offense" class="lex flex-row items-start mt-3">
                <div class="flex flex-row items-center">
                ...
                <div class="flex flex-row items-center">
                  <p class="text-sm font-medium mb-3 mr-4 text-gray-300 font-mono mt-2 w-36 flex-shrink-0">Helpful typing:</p>
                  <Type
                ...
                <div class="flex flex-row items-center">
                  <p class="text-sm font-medium mb-3 mr-4 text-gray-300 font-mono mt-2 w-36 flex-shrink-0">Attack type:</p>
                  <img class="w-6 mr-1" :src="`/icons/${pokedex.pokemonPrimaryDefenseVector}.png`" /><span class="w-5 font-mono text-white text-sm">{{ pokedex.pokemonPrimaryDefenseVector }}</span>
                </div>
              </div>
              ...
              <div id="player-overlap" class="lex flex-row items-start mt-3">
                <div class="flex flex-row items-center">
                  <Type 
              ...
              <div class="flex flex-col items-start mt-3">
                ...
                <div class="bg-black bg-opacity-20 rounded-xl w-full px-4 pb-3">
